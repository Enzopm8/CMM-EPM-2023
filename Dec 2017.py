...
# Define the function y(x) as exp(-x) and add the perturbation
y = sym.exp(-x + 0.1) 

#solve the epansion of y func w.r.t x for 3 terms and print
taylor = y.series(x, n=5)
...
# Calculate sensitivity using the formula
...
# Define the equation to find the interest rate
equation = lambda i: present_worth * (i * (1 + i)**number_of_years) / ((1 + i)**number_of_years - 1) - annual_payments

# Use Newton-Raphson method to find the root (interest rate)
...
#                                 Q3 
print('\n------ Q3. a,b,c)------\n')
#assume when x = 0, z = 20 and gradient is 0.02
import numpy as np
