...
def model(x, y):
    # System Defined Parameters <----------------SPECIFY
    sigma = 10.0
    beta = 8.0 / 3.0
    rho = 28.0
...
x0 = 0          #start of range
y0 = [5, 5, 5]  # Initial values for y_1, y_2, y_3 <---- SPECIFY
t_final = 30    #final time

# ------------------------------------------------------
# Apply solve_ivp method to solve the ODEs
t_eval = np.linspace(0, t_final, num=5000) #5000 elements equispaced in the range

#Call the function <--------------------------------------SPECIFY
